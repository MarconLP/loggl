      ...
      <div className="bg-white">
              ...
              {[1, 2].map((x) => (
                <div
                  ...
                  className={`flex flex-row whitespace-nowrap py-12 ${
                    x === 1
                      ? "animate-marquee"
                      : "animate-marquee2 absolute top-0"
                  }`}
                >
                  {[
                    {
        ...
        <div className="mx-auto max-w-7xl py-32">
          <div className="flex flex-col items-center justify-center text-center">
            <span className="text-2xl font-bold tracking-tight text-gray-900 sm:text-4xl">
              Easy to integrate
            </span>
            <span className="mt-4 max-w-[75%] text-[#6c6684]">
              Loggl is pretty much compatible with everything, since it is only
              an http request.
            </span>
          </div>
        ...
        <div className="mx-auto flex max-w-7xl flex-col justify-center gap-y-16 py-8 sm:flex-row sm:py-16">
          ...
          <div className="flex flex-1 flex-col items-center justify-center text-center">
            ...
            <span className="mt-4 max-w-[75%] text-[#6c6684]">
              Interested in self-hosting Loggl? Spin up loggl.net in just a few
              commands.
            </span>
          </div>
        </div>
        ...
        <div className="mx-auto max-w-7xl py-16">
          <div className="flex flex-col items-center justify-center text-center">
            ...
            <span className="mt-4 max-w-[75%] text-[#6c6684]">
              Access your events and metrics in realtime from any device, and
              keep track of your business no matter where you are.
            </span>
          </div>
        </div>
